...
say ""
say "One manual step this installer deliberately does NOT make for you:"
say "  Claude Code >= v2.1.217 gives unnamed sub-agents no Agent tool by default, so"
say "  they cannot spawn children. Most of this suite delegates that way — without the"
say "  setting below those runs do not error, they silently collapse into one context."
say "  Add to the \"env\" block of your settings.json, then restart Claude Code:"
say "      \"CLAUDE_CODE_MAX_SUBAGENT_SPAWN_DEPTH\": \"4\""
say "  Details: docs/field-notes.md section 5. Your settings.json, your call."
